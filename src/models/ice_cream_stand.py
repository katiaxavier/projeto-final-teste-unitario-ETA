...
class IceCreamStand(Restaurant):
    ...
    def flavors_available(self):
        ...
        if self.flavors:
            ### print("\nNo momento temos os seguintes sabores de sorvete disponíveis:") --- Coloquei na linha 20
    ...
    def find_flavor(self, flavor):
        ...
        if self.flavors:
            if flavor in self.flavors:
                return f"Temos no momento {self.flavors}!"      ### Adicionando o return
            else:
                return f"Não temos no momento {flavor}!"          ### Estava self.flavors, Trocando para flavor e adicionando o return
        else:
